...
object Constants {
    ...
    val FULL_TIME_STUDIES_DAYS_LIST2 = listOf("Monday", "Tuesday", "Wednesday", "Thursday", "Friday")
    val FULL_TIME_STUDIES_DAYS_LIST = listOf("Mo", "Tu", "We", "Th", "Fri")
    val PART_TIME_STUDIES_DAYS_LIST2 = listOf("Saturday", "Sunday")
    val PART_TIME_STUDIES_DAYS_LIST = listOf("So", "Su")
